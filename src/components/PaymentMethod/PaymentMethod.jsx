...
import card from './PaymentMethod/CARD.svg'
        ...
        <div className="container">
            ...
            <div className="row justify-content-center">
                <div className="col-md-4 col-sm-6 text-center mb-4 payment-method">
                    <img src={card} alt="" className="img-fluid payment-icon" />
                    <p className="mt-2 mb-0 payment-text">Tarjeta de débito/crédito</p>
                </div>
                <div className="col-md-4 col-sm-6 text-center mb-4 payment-method">
