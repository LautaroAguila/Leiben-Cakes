            ...
            <div className="row">
                ...
                <div className="col-md-6 d-flex align-items-center">
                    <div className='tex-about-us'>
                        <p className="text-center mb-4">Durante la pandemia, descubrimos que la pasión por la pastelería puede transformar los momentos difíciles en oportunidades dulces. Así nació nuestro emprendimiento, con una visión clara: compartir el arte de la pastelería.</p>
                        <p className="text-center mb-4">Soy Luciana Ortiz, pastelera titulada con 8 años de experiencia en el mundo de los dulces. Desde chica me encanta comer cosas dulces, y practicaba algunas recetas para tener mi merienda y postre. Comencé en el año 2016 haciendo mi primer curso de pastelería. Ahí aprendí lo básico de cualquier receta, y siempre he buscado aportar mi toque personal a cada una.</p>
                        <p className="text-center mb-4">Una vez concluido exitosamente ese curso, decidí que mi profesión era esa; la pastelería no solo se volvió mi oficio, sino también mi pasión, y con esto me refiero a lo que me llena el alma. Con esta dedicación cada una de mis recetas y productos tienen el mejor ingrediente, mucho amor.</p>
                        ...
                        <p className="text-center mb-4">Con más seguridad, en pandemia 2020 creé una página de Facebook e Instagram Lieben.cake, donde sigo subiendo contenido, generando seguidores y clientes. Hoy en día, mis redes sociales siguen activas, y mi meta es seguir creciendo.</p>
